...
clang-17 -emit-llvm -c ${BENCH} -Xclang -disable-O0-optnone -o ${1}.bc -Wno-deprecated-non-prototype

# Instrument profiler passes. Generates profile data.
opt-17 -passes='pgo-instr-gen,instrprof' ${1}.bc -o ${1}.prof.bc

# Generate binary executable with profiler embedded
clang-17 -fprofile-instr-generate ${1}.prof.bc -o ${1}_prof
...
llvm-profdata-17 merge -o ${1}.profdata default.profraw
